mport { Play32, Pause32 } from '@carbon/icons-react';
...
import {
  ...
  vimeo,
  videoIsPlaying,
} from 'gatsby-theme-carbon/src/components/Video/Video.module.scss';
import usePathPrefix from 'gatsby-theme-carbon/src/util/hooks/usePathprefix';

const Video = ({ autoPlay, vimeoId, youtubeId, title, src, poster, muted, ...props }) => {
