...
- Copy the 7 digit code and apply to verify the registered email address is valid
  
  ![IBM Cloud Account Creation Success](images/ApplyCode.png)

- Email Address is successfully verified and Click Create Account

  ![IBM Cloud Account Email Verify](images/EmailVerified.png)

- Once the account creation is Successful, you will receive an email to the registered address.
