...
You can assign policy to the access group via "Assign Policy". The following diagram outlines list of access assigned to the access group.

![IBM Cloud IAM Policy List](images/IAMPolicyList.png)

**Add Users**

You can add users to the Access group via "Add Users". The following diagram outlines list of users added to the access group.

![IBM Cloud IAM Policy List](images/Users.png)
## **Resources**
