...
https://github.com/yogendrasri/secured-microservices-writing-to-a-consolidated-



### **Command to start application**

User can get HPCS parameters from HPCS service overview page and MongoDB parameters from HPDBBAS for MONGODB Service manage page.
