...
- Create a generation 2 virtual server instance. By default, a 100 GB boot volume is attached to the instance.
...
### Create a edge-node1 virtual machine (virtual server) within the VPC:
