...
![IBM Cloud VPC Edge](images/vpc2.png?raw=true {width=40px height=400px} )
...
![IBM Cloud VPC Subnet](images/vpc3.png?raw=true {width=40px height=400px} )

#### **3. Reserve IP**

- If you want your instance to be reachable from the internet, reserve and associate a floating IP address.

![IBM Cloud VPC IP Range](images/vpc4.png?raw=true {width=40px height=400px} )
...
![IBM Cloud VSI Edge](images/vsi.png?raw=true {width=40px height=400px} )
...
![IBM Cloud VSI OS](images/vsios.png?raw=true {width=40px height=400px})
