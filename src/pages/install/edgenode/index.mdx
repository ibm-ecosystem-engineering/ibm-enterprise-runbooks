...
## Install a edge node with just K3s or docker 

The following instructions guide you through the process of installing the open source project, K3s or Docker on your edge device and registering it with IBM Edge Application Manager IEAM.

<Tabs>

<Tab label="K3s">

## Install a edge node with just K3s

The following instructions guide you through the process of installing the open source project, k3s, which is a lightweight, easy to install Kubernetes distribution geared towards resource-constrained environments and low touch operations on your edge device and registering it with IBM Edge Application Manager IEAM.

```
curl -sfL https://get.k3s.io | sh -
```

Execute CLI to verify if k3s is running.
...
The following instructions guide you through the process of installing the docker on your edge device and registering it with IBM Edge Application Manager IEAM.

 - Create a VM on VPC (Refer to procedure above)
