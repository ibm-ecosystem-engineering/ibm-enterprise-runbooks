...
<AnchorLinks>
  ...
  <AnchorLink>App Connect Designer</AnchorLink>
  <AnchorLink>App Connect Dashboard</AnchorLink>
  <AnchorLink>Operations Dashboard</AnchorLink>
  <AnchorLink>Asset Repository</AnchorLink>
  <AnchorLink>Queue Manager</AnchorLink>
