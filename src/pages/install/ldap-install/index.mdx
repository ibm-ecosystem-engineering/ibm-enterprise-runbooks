...
1. With a web browser log into the phpLDAPAdmin page, the address is http://localhost:9580/phpldapadmin
...
2. Create a child entry of users, of Default type.  
 ...
 - Press Proceed.  Then select User Name (uid) for the RDN, and enter in the username for the cn and sn fields.  Create one for yourself first, you’ll do this same procedure for all users.
...
3. Continue to create as many users as you want.  After you have created the users, you need to create at least one group.  Create a child entry off the top node of type Organisational Unit, call it groups.
 
4. Press Create Object and confirm.
 ...
 - You must add at least one actual user to this group, choose your user id.  The uniqueMember must be of the form;
    uid=<username>, ou=<username>, dc=gsi, dc=org.
