...
Before you proceed, make sure you have completed developer intermediate journey and have IBM Partner Sandbox invite. It is a paid IBM Cloud account with the [Developer Tools environment](../getting-started/devenvsetup) already installed and ready for you to use, including both a Kubernetes cluster and an OpenShift cluster. (The environment is locked down to prevent creating any new services.) Also, before proceeding:
...
| **Continous Delivery** | | | |
| Continous Delivery (CD) | Overview | [CD](/developer-intermediate/continuous-delivery) | 15 mins |
| CD Implementation | Application Delivery with Gitops | [Gitops](/developer-advanced/gitops) | 15 mins |
| **Database Integration** | | | |
| Cloudant | Integrate Backend with Cloudant Database | [Cloudant](/developer-advanced/inventory-cloudant) | 15 mins |
| MongoDB | Integrate Backend with MongoDB Database | [MongoDB](/developer-advanced/inventory-mongodb) | 15 mins |
| Postgres | Integrate Backend with Postgres Database | [Postgres](/developer-advanced/inventory-postgres) | 15 mins |
| **Authentication** | | | |
| App ID | Secure the solution with App ID  | [App ID](/developer-advanced/inventory-appid/) | 15 mins |
| **API Consumption** | | | |
| API | Consume API from client applications  | [API Consumption](/developer-advanced/inventory-api/) | 15 mins |
| Mobile App | Mobile App consuming API's  | [Mobile App](/developer-advanced/inventory-mobile-app/) | 15 mins |
| **Advanced Monitoring and Logging** | | | |
| Monitoring | Advanced Monitoring with Sysdig | [Advanced Monitoring](/developer-advanced/monitoring/) | 30 mins |
| Log Management | Advanced Log Management with LogDNA | [Advanced Log Management](/developer-advanced/log-management/) | 30 mins |
| **DevSecOps** | | | |
...
| **Operators** | | | |
| Operator Overview | Operators are a method of packaging, deploying, and managing a Kubernetes application |[Operator](/developer-advanced/operator/) | 15 min |
| Operator Labs | Developing operator step by step |[Operator Labs](/developer-advanced/operator/lab) | 45 min |
